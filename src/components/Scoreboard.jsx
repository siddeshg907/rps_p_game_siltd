    ...
    <div className="flex flex-col bg-white rounded-lg items-center text-sm md:text-xl text-gray-900 font-bold p-2">
      ...
      <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
        <div className="p-1 text-center">
          <div className="font-bold text-green-500 text-base md:text-lg">Wins:</div>
          <div className="text-base md:text-lg">{scores.win}</div>
        </div>
        <div className="p-1 text-center">
          <div className="font-bold text-red-500 text-base md:text-lg">Losses:</div>
          <div className="text-base md:text-lg">{scores.lose}</div>
        </div>
        <div className="p-1 text-center">
          <div className="font-bold text-yellow-500 text-base md:text-lg">Draws:</div>
